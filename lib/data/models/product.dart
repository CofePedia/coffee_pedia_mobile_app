...
*/
  ...
  ProductDataSubCategory.fromJson(Map<String, dynamic> json) {
    id = json['id']?.toInt();
...
/*
{
  ...
  "vendor_id": 61,
  "images": [
    "https://api-staging.coffepidia.com/saved_images/products/JqqFLKZ6x3vvRy0YfT5745OdLbc3LCq9sR1Ishr5.jpg"
  ],
...
*/
  ...
  ProductDataSubCategory? subCategory;
  ...
  ProductData.fromJson(Map<String, dynamic> json) {
    ...
    subCategory = (json['sub_category'] != null)
        ? ProductDataSubCategory.fromJson(json['sub_category'])
        : null;
  }
  Map<String, dynamic> toJson() {
    final data = <String, dynamic>{};
