...
class TermsAndConditionsScreenProvider extends StatelessWidget {
  const TermsAndConditionsScreenProvider({Key? key}) : super(key: key);
...
class _TermsAndConditionsScreenState extends State<TermsAndConditionsScreen> {
  @override
  void initState() {
    BlocProvider.of<StaticPagesCubit>(context).getTermsAndConditions();
    super.initState();
  }
          ...
          child: Padding(
            ...
            child: BlocBuilder<StaticPagesCubit, StaticPagesState>(
              builder: (context, state) {
                if (state is TermsAndConditionsIsLoaded) {
                  return Column(
