        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                translator
                    .translate("coffeeShops_screen.coffee_shops_near_you"),
              ...
              CustomTextFormField(
                hintText:
                    '${translator.translate("coffeeShops_screen.search")} …',
                width: 345.w,
                  ...
                  RichText(
                    ...
                    text: TextSpan(
                      children: <TextSpan>[
                        TextSpan(
                          text: translator
                              .translate("coffeeShops_screen.coffee_shops"),
                          style:
                        ...
                        TextSpan(
                          text:
                              '(156 ${translator.translate("coffeeShops_screen.item")})',
                          style:
                              Theme.of(context).textTheme.headline1!.copyWith(
                                    fontSize: 12.sp,
                                  ),
